...
**Time specific effects on the proportion of sprouted spores in each condition - again for 'LD' experiment:**    
```{r}
...
**ANOVA summary for effect on all time points - again for 'LD' experiment:**   
```{r}
...
Access **data_prop_long** for **GA3** experiment    
...
Access result from **linear mixed effects model** for **GA3** experiment and **'9650_KO'** as reference level   
...
Access result from **ANOVA** for **GA3** experiment and **'9650_KO'** as reference level   
